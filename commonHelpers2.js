import{m as d,a as S,i as s}from"./assets/handle-menu-buttons-40d72d31.js";const u=document.querySelectorAll(".button-home"),f=document.querySelectorAll(".button-portfolio");d(f,u);f.forEach(o=>{o.addEventListener("click",e=>{d([o],u)})});S();function x(o){return o.map(e=>`
  ...
  `).join("")}const j="/my-portfolio/assets/dynamic-8b6e8422.jpg",U="/my-portfolio/assets/ukr-24-8c6d5624.jpg",C="/my-portfolio/assets/chocolate-96ef87ef.jpg",E="/my-portfolio/assets/webstudio-c42042b3.jpg",A="/my-portfolio/assets/phone-book-1beeeb0f.jpg",H="/my-portfolio/assets/film-library-a8a40eb8.jpg",I="/my-portfolio/assets/movies-f2c1add6.jpg",h=[{id:1,type:"Project",teamLeader:"Team Leader",imgSrc:"../../img/dynamic.jpg",imgUrl:j,githubLink:"https://vpresich.github.io/dynamics/",name:"Dynamics",participants:9,languages:["HTML5","CSS3","JavaScript"],target:"Study",short:`The app "Dynamics" provides a comprehensive platform for workout enthusiasts,
...
and other important information about our app.`},{id:3,type:"Project",teamLeader:"Developer",imgSrc:"../../img/chocolate.jpg",imgUrl:C,githubLink:"https://vpresich.github.io/goit-markup-classwork-chocolate/",name:"Chocolate",participants:1,languages:["HTML5","CSS3","JavaScript"],target:"Study",short:`The application offers a unique platform for chocolate enthusiasts,
...
Leveraging the power of JavaScript, the app utilizes APIs to fetch movie data from external sources, providing up-to-date information and a rich browsing experience. Whether you're a casual movie enthusiast or a dedicated cinephile, the "FilmLibrary" app is your go-to tool for managing and enjoying your movie collection.`},{id:7,type:"Project",teamLeader:"Developer",imgSrc:"../../img/movies.jpg",imgUrl:I,githubLink:"https://goit-react-hw-05-lac-nine.vercel.app/",name:"Movies",participants:1,languages:["React"],target:"Study",short:'The "Movies" app is a comprehensive platform for managing your movie collection. With its user-friendly interface and powerful features, organizing and accessing your favorite films has never been easier.',desc:` Key Features. Easily search and browse through a vast library of movies using intuitive filters and sorting options.
Add new movies to your collection or edit existing ones, including details such as title, genre, release year, director, and more.
Leveraging the power of React, the app utilizes APIs to fetch movie data from external sources, providing up-to-date information and a rich browsing experience. Whether you're a casual movie enthusiast or a dedicated cinephile, the "FilmLibrary" app is your go-to tool for managing and enjoying your movie collection.`}];function $(o){const e=x(h);o.innerHTML=e}const m=".portfolio-js",q="gallery-start",B="gt-link-js",M=".portfolio-close-btn",R="Escape",D=".modal-backdrop",g="is-open",c=document.querySelector(m);c&&$(c);function F(o={}){const{id:e,type:i,teamLeader:l,img:J,imgUrl:y,name:b,participants:w,languages:k,target:L,short:T,desc:K}=o;return`
              ...
              <div class="portfolio-params-container">
                <ul class="portfolio-params">
                  ...
                  <li class="portfolio-params-card">
                    ...
                    <p class="portfolio-param-value portfolio-param-popularuty">${w}</p>
                  </li>
                </ul>
      ...
      `}const P=(o,e)=>{const i=F(o);e.innerHTML="",e.insertAdjacentHTML("beforeend",i)};function O(o){return h.find(e=>e.id==o)}let r,a,t=document.querySelector(D);t&&t.addEventListener("click",Y);const p=document.querySelector(m);p&&p.addEventListener("click",_);function _(o){o.preventDefault();const e=o.target;if(e.classList.contains(q)){if(e.nodeName!=="BUTTON"?a=e.closest("BUTTON").dataset.id:a=e.dataset.id,!a)return;const i=O(a);P(i,t),z()}else{const i=W(e);i&&window.open(i,"_blank","noreopen")}}function W(o){let e,i;return o.classList.contains(B)&&(o.nodeName==="a"?i=o:i=o.closest("a")),i&&(e=i.getAttribute("href")),e}function n(o){window.removeEventListener("keydown",v),t.classList.remove(g)}function z(){t.classList.add(g),window.addEventListener("keydown",v),r=document.querySelector(M),r&&r.addEventListener("click",n)}function v(o){o.code===R&&n()}function Y(o){o.currentTarget===o.target&&n()}
