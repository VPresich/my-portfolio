import{i as l,m as h,a as U,c as I,s as S,S as k,g as M,o as L}from"./assets/modal-window-handle-6f0b6a16.js";function C(e){return e.map(t=>{const{title:i,company:s,period:a,duties:o,isAwards:c,awards:m}=t,p=o.map(A=>`<li class="duties-list-item">${A}</li>`).join("");return`
    ...
    `}).join("")}function D(e){let t="";const{isAwards:i,awards:s}=e;let a="";return i&&(a=s.map(o=>`<li class="awards-list-item">
  ...
  `).join("")}const H="/my-portfolio/assets/cisco-cybersecurity-d427ef46.png",u="/my-portfolio/assets/cisco-js1-2b9ae2af.png",F=[{id:1,sertImgSrc:H,sertImgUrl:"https://www.credly.com/badges/d6ea3773-467b-4918-9086-d4ab36940bec/public_url",sertImgAlt:"Introduction to Cybersecurity",sertTitle:"Introduction to Cybersecurity",sertDate:"Dec 2023"},{id:2,sertImgSrc:u,sertImgUrl:"https://www.credly.com/badges/1f678ba2-192e-4bcf-bd42-c3a974a8b3f6/public_url",sertImgAlt:"JavaScript Essentials 1",sertTitle:"JavaScript Essentials 1",sertDate:"Dec 2023"},{id:3,sertImgSrc:u,sertImgUrl:"https://www.credly.com/badges/1293d70e-ad5d-4860-81d7-0ff61d07a300/public_url",sertImgAlt:"Python Essentials 1",sertTitle:"Python Essentials 1",sertDate:"Dec 2023"}];function G(e){const t=_(F);e.innerHTML=t}const V=".experience-js",J="Certifications",W="Education",z="Experience";let n=null;const g="filter-button-active",r=document.querySelector(V),d=document.querySelector(".filters-buttons");d&&(n=d.firstElementChild,d.addEventListener("click",X));function X(e){if(e.preventDefault(),e.target.tagName!=="BUTTON")return;switch(e.target.dataset.filter){case z:v(r);break;case W:K(r);break;case J:console.log("Filter by Certifications"),G(r);break;default:console.log("Unknown filter")}Y(e.target)}function Y(e){n&&n.classList.remove(g),e&&e.classList.add(g),n=e}r&&v(r);const y=document.querySelectorAll(".button-home"),w=document.querySelectorAll(".button-favorites");h(y,w);w.forEach(e=>{e.addEventListener("click",t=>{h([e],y)})});U();const Q={iconURL:l,iconContainerClass:"social-item-footer",iconLinkClass:"social-link-footer",iconClass:"social-icon"},Z=document.querySelector(".social-list");I(Z,Q,S);function ee(e={}){const{imgUrl:t}=e;return`
      ...
      `}const te=(e,t)=>{const i=ee(e);t.innerHTML="",t.insertAdjacentHTML("beforeend",i)},ie=".container-filters",b="diploma-js",se=document.querySelector(k),f=document.querySelector(ie);f&&f.addEventListener("click",ae);function ae(e){e.preventDefault();const t=e.target;if(t.classList.contains(b)){const i=oe(t);i&&(te({imgUrl:i},se),L())}else{const i=M(t);i&&window.open(i,"_blank","noreopen")}}function oe(e){let t,i;return e.classList.contains(b)&&(e.nodeName==="a"?i=e:i=e.closest("a")),i&&(t=i.getAttribute("href")),t}
